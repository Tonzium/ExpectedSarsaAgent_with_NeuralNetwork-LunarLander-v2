...
with open("demo_parameters.json", "r") as f:
...
weights_path = "results/weights_expected_sarsa_agent.npy"
...
def test_agent_and_save_frames(env_name, num_episodes=1):
    ...
    for episode in range(num_episodes):
        ...
        while not done:
            ...
            frames.append(frame)
            state, reward, done, _, _ = env.step(action)  # Take a step in the environment
            if not done:
...
frames = test_agent_and_save_frames('LunarLander-v2', 1)
